...
export default function Courses() {
  return (
    <section className="bg-[#0E091D] py-20 flex flex-col justify-center items-center">
      <div className="container mx-auto mb-auto">
        ...
        <div className="flex flex-col items-center lg:flex-row xl:flex-row justify-center">
          ...
          <div className="flex flex-col items-center text-center bg-[#D9D9D9] w-64 rounded-md shadow-md p-6 m-4 max-w-sm py-20 lg:py-10 px-10">
            <Image
          ...
          <div className="flex flex-col items-center text-center bg-[#D9D9D9] w-64 rounded-md shadow-md p-6 m-4 max-w-sm py-20 lg:py-16 px-10">
            <Image
              src="/nextJS.png"
              width="100"
              height="100"
      ...
      <div className="flex flex-col items-center m-16 justify-center text-center">
      ...
      <div className="flex flex-col bg-[#D9D9D9] rounded-md shadow-md p-16 mx-64">
        <h1 className="flex justify-center text-[#1E1E1E] font-bold text-center text-2xl font-mono">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-center lg:justify-between">
          <div className="lg:w-2/5">
            <Image
              ...
              className="rounded-3xl mt-8 mb-10"
            />
          </div>

          <div className="flex flex-col justify-center lg:w-1/2">
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-end">
              <div className="flex flex-col justify-center items-center lg:items-start lg:mt-3">
                <h6 className="text-[#041E48] text-md font-bold font-mono lg:text-center">
                  Quarter 3
                </h6>
                ...
                <p className="text-[#0E091D] text-sm font-mono max-w-sm text-center pb-5 lg:w-44">
              ...
              <div className="flex flex-col justify-center items-center lg:items-start mt-8 lg:mt-0">
                ...
                <p className="text-[#0E091D] text-sm font-mono max-w-sm text-center lg:w-44">
      ...
      <div className="flex flex-col bg-[#D9D9D9] rounded-md shadow-md p-16 mx-64 mt-10">
        <h1 className="flex justify-center text-[#1E1E1E] font-bold text-center text-2xl font-mono">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-center lg:justify-between">
          ...
          <div className="flex flex-col justify-center lg:w-1/2 mt-9">
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-end">
              <div className="flex flex-col justify-center items-center lg:items-start lg:mt-3">
                <h6 className="text-[#041E48] text-md font-bold font-mono lg:text-center">
                  Quarter 3
          ...
          <div className="flex flex-col justify-center lg:w-1/2 mt-9">
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-end">
              ...
              <div className="flex flex-col justify-center items-center lg:items-start mt-8 lg:mt-0">
                ...
                <p className="text-[#0E091D] text-sm font-mono max-w-sm text-center lg:w-44">
                  <strong className="font-bold ">Bio-361: </strong>
